  ...
  return (
    <div className="bg-[url('../../public/bg2.png')] bg-repeat font-custom pt-7 ">
      ...
      <div className="flex flex-row justify-around">
        <div className="font-bold text-3xl  mt-10 mb-5 px-5 ml-12 max-w-[600px] pt-5 leading-relaxed border-4 border-violet-900/35  h-fit pb-4 text-center  bg-[url('../../public/bg1.png')] bg-repeat rounded-xl shadow-2xl">
        ...
        <form ref={form} onSubmit={sendEmail} className="flex flex-col items-center pb-16 mt-10">
          <div className="m-3">
            ...
            <input type="text" name="user_name" className="font-bold text-2xl pl-3 bg-[url('../../public/bg1.png')] bg-repeat min-h-14 min-w-[600px] rounded-xl border-4 border-violet-900/35"/>
          </div>
          <div>
            <label className="mr-3 font-bold text-3xl">Email</label>
            <input type="email" name="user_email" className="font-bold text-2xl pl-3 bg-[url('../../public/bg1.png')] bg-repeat min-h-14 min-w-[600px] rounded-xl border-4 border-violet-900/35"/>
          </div>
          <div className="flex flex-row items-start m-3">
            <label className="mr-3 font-bold text-3xl">Message</label>
            <textarea name="message" className="font-bold text-xl pl-3 mt-3 bg-[url('../../public/bg1.png')] bg-repeat min-h-40 min-w-[600px] rounded-xl border-4 border-violet-900/35"/>
          </div>
